...
$app->configureMonologUsing(function($monolog) {
	...
	$warningHandler = new Monolog\Handler\StreamHandler(storage_path("logs/warning.log"), Monolog\Logger::WARNING, false);
	$errorHandler = new Monolog\Handler\StreamHandler(storage_path("logs/error.log"), Monolog\Logger::ERROR, false);
